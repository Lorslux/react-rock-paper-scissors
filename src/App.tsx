...
<div className="main-container">
 <header>
   ...
   <div className="box-img-tittle">
     <div id="img-title-rock" className="img-title"></div>
     <div id="img-title-paper" className="img-title"></div>
     <div id="img-title-scissors" className="img-title"></div>
   </div>
   <h2>New game</h2>
 </header>
 <main>
   <nav className="main-nav">
     <div className="main-nav-item">
       <a href="playervspc.html" className="button">Player vs PC</a>
     </div>
     <div className="main-nav-item">
       <a href="pcvspc.html" className="button">PC vs PC</a>
     </div>
     <div className="main-nav-item">
       <button onClick={handleInstructionsButton} id="instructions-button" className="button" type="button">
         How to play
       </button>
     </div>
   </nav>
...
<div id="instructions" className="instructions">
 ...
 <div className="instructions-content">
   ...
   <p>It's a tie when both players chose the same hand sign, this means no one gets points.</p>
   ...
   <div className="box-instruction-button">
     ...
     <div className="img-button-text">It resets the actual score so a new game will start</div>
   </div>
   <div className="box-instruction-button">
     <div className="img-button">
   ...
   <div className="box-instruction-button">
     ...
     <div className="img-button-text">To start playing the game (only avaliable on PC vs PC)</div>
   </div>
   <div className="box-instruction-button">
     <div className="img-button img-start-button">
       <img src="./img/score.png" alt=""/>
     </div>
     <div className="img-button-text">Score: The one with the majority of points is the actual winner</div>
   </div>
   
 </div>
 <div className="instructions-footer">
   <button
     onClick={handleCloseButton} id="close-instructions"
